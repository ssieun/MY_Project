...
<html>
	...
	<style>
		...
		.my{width: 85% !important; height: 400px !important; margin-left: 20px !important;}
	...
	<section id="main" class="wrapper style1">
		...
		<center>
			...
			<div class="col-6 col-12-xsmall">
				...
				<input type="text" id="name" name="name" style="width: 60%; margin-bottom: 20px;" />
			</div>
				
			<div class="col-6 col-12-xsmall">
				<label for="id">ID</label> 
				<input type="text" name="id" style="width: 60%; margin-bottom: 20px;" />
			</div>
			...
			<div class="col-6 col-12-xsmall">
				...
				<input type="text" name="email" class="code" style="width: 39%; margin-bottom: 10px; display: inline;" />
				<input type="button" id="email_button" value="인증번호 발송" >
			</div>
					
			<div class="col-6 col-12-xsmall">
				<input type="text" name="code" class="code"style="width: 39%; margin-bottom: 10px; display: inline;" /> 
				<input type="button" id="code_button" value="인증번호 확인" onclick="codeCheck()">
			</div>

			<div class="col-12">
				<textarea name="message" id="message" rows="6" style="width: 69%; height: 50%; resize: none; margin-top: 30px;" readonly>
시행일자 : 2020년 11월 16일

제1조 (목적)
본 약관은 sieun 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
본 약관은 2020년 11월 16일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
			...
			<div class="col-6 col-12-small">
				...
				<label for="human">
				<span style="color: red; font-weight: 900">[필수]</span>약관 및 개인정보 수집/이용 동의</label>
			</div>

			<ul class="actions">
				<li style="margin: 0 auto"><a type="submit" class="button primary finish">Sign up</a></li>
			</ul>
